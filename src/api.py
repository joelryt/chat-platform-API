...
api.add_resource(MediaCollection, "/threads/<thread:thread>/messages/<message:message>/media/")
api.add_resource(MediaItem, "/threads/<thread:thread>/messages/<message:message>/media/<media:media>/")
